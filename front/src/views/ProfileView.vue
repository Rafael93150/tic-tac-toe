...
import GamesHistory from "@/components/profile/GamesHistory.vue";
...
<template>
	<LayoutAuthenticated>
		<div
			v-if="state.user"
			class="flex-1 max-w-7xl mx-auto my-8 px-4 sm:px-6 lg:px-8"
		>
				...
				<div class="pb-16 pt-4">
					...
					<div class="px-4 sm:px-6 lg:px-0">
							...
							<div v-if="state.tabs[0].current">
								...
								<div class="mt-10 divide-y divide-gray-200">
									<div class="space-y-1">
										...
										>
											Vous pouvez modifier votre profil à
                      ...
                      minuscule, un chiffre et un caractère spécial. -->
											...
											passe à tout moment depuis cette
											page.
										</p>
									</div>
									<div class="mt-6">
								...
								<div class="mt-10">
									<div class="space-y-1">
										...
										<p
											class="max-w-2xl text-sm text-gray-500"
										>
											Retrouvez ici l'historique de vos
											parties.
										</p>
										<GamesHistory />
									</div>
